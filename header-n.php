        ...
        <div id="menu-in">
            ...
            <nav id="nav">
                <ol class="nav-list">
                    ...
                    <li class="nav-item"><a href="index.php" class="nav-link" title="Tienda Oficial">TIENDA</a>
                    </li>
                </ol>
            </nav>
            ...
            <nav class="offScreenMenu" id="burger">
                <ol class="lista-off">
                    ...
                    <li class="item-off"><a href="index.php" class="link-off"
                            title="Ver competiciones y clasificación">COMPETICIONES</a>
                    </li>
                    <li class="item-off, last"><a href="index.php" class="link-off" title="Tienda Oficial">TIENDA</a>
                    </li>
                </ol>
            </nav>
            ...
            <div id="busq-user-car">
                <ol>
                    ...
                    <li><a href="index.php" title="Perfil de usuario"><img
